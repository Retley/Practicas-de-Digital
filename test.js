...
describe('Concesionaria de Autos', function () {
  it('debería mostrar la información de los autos', function () {
    const resultado = mostrarInformacionAutos(autosPrueba);
    expect(resultado).to.be.equal(autosPrueba);
  });

  it('debería filtrar autos por marca', function () {
 ...
 it('debería calcular el precio promedio de los autos', function () {
 ...
 it('debería incrementar el precio de todos los autos en un 10%', function () {
 ...
 it('debería encontrar el auto con el menor kilometraje', function () {
    const resultado = encontrarAutoMenorKilometraje(autosPrueba);
    expect(resultado.kilometraje).to.equal(40000);
  });

  it('debería ordenar autos por precio de menor a mayor', function () {
